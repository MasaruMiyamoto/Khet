...
//					}
	...
	void cpuGame (int x, int y, Vector3 vec)
	{
		
		//Pyramid
		if (x == 0 && y == 4) 
			setKoma (true, vec, 90, 1, this.Pyramid);
		...
		//Scarab
		if (x == 4 && y == 4) 
			setKoma (true, vec, 0, 9, this.Scarab);
		...
		//Anubis
		if (x == 4 && y == 7) 
			setKoma (true, vec, 180, 11, this.Anubis);
		
		if (x == 5 && y == 6) 
			setKoma (true, vec, 180, 12, this.Anubis);
		...
		//Pyramid
		if (x == 2 && y == 0) 
			setKoma (false, vec, 90, 21, this.Pyramid);
		
//		if (x == 2 && y == 4) 
//			setKoma (false, vec, -90, 22, this.Pyramid);
		
//		if (x == 5 && y == 4) 
//			setKoma (false, vec, 180, 23, this.Pyramid);
		
		if (x == 9 && y == 3) 
			setKoma (false, vec, -90, 24, this.Pyramid);
		
		if (x == 8 && y == 4) 
			setKoma (false, vec, 0, 25, this.Pyramid);
...
//			setKoma (false, vec, 180, 31, this.Anubis);
		...
		if (x == 5 && y == 0) 
			setKoma (false, vec, 0, 32, this.Anubis);
